...
pd.DataFrame({"Actual": test_origin_target, "Predicted": y_pred}).to_csv(f"/Users/ericliao/Desktop/GLMM_binary_result_{state_code}.csv")
...
pd.DataFrame({"Actual": test_origin_target, "Predicted": y_pred_binary}).to_csv(f"/Users/ericliao/Desktop/"
                                                                                f"GLMM_maximum_f1_binary_prediction_vs_real_{state_code}.csv")
...
# plt.show()
plt.savefig(f"/Users/ericliao/Desktop/GLMM_binary_ROC_{state_code}.png")
plt.close()
...
plt.savefig(f"/Users/ericliao/Desktop/GLMM_binary_histogram_{state_code}.png")
plt.close()
...
plt.savefig("/Users/ericliao/Desktop/GLMM_binary_scatter_NY.png")
plt.close()
...
plt.savefig(f"/Users/ericliao/Desktop/GLMM_binary_scatter_{state_code}.png")
plt.close()
...
plt.savefig(f"/Users/ericliao/Desktop/GLMM_binary_KDE_{state_code}.png")
plt.close()
