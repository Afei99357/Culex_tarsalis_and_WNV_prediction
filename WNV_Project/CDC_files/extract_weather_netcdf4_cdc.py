...
human_neural_df = pd.read_csv("/Users/ericliao/Desktop/WNV_project_files/CDC-DATA-2023/monthly/conbine_cdc_weather_2.csv",
                              index_col=False)
...
latitude_da = xr.DataArray(human_neural_df["County_Seat_Latitude"].values, dims="county").compute()
# create a data array based on the longitude from human_df
longitude_da = xr.DataArray(human_neural_df["County_Seat_Longitude"].values, dims="county").compute()
# create a data array based on the date from nonhuman_df
time_da = xr.DataArray(human_neural_df["Date"].values.astype("datetime64[D]"), dims="county").compute()
...
human_neural_df.to_csv(
    "/Users/ericliao/Desktop/WNV_project_files/CDC-DATA-2023/monthly/conbine_cdc_weather_12.csv",
    index=False,
)
