...
## store the first 5 principal components as a new predictor
data_pred_pca = pca.transform(scaled_df)[:, :5]

## add the target column to the data_pred_pca
data_pred_pca = pd.DataFrame(data_pred_pca, columns=["PC1", "PC2", "PC3", "PC4", "PC5"])
...
plt.legend()
plt.title("Loss")
plt.savefig("/Users/ericliao/Desktop/WNV_project_files/WNV/CDC_data/human/result/NN/nn_yearly_loss_pca_"+ loss_name +".png", dpi=300)
plt.show()
...
plt.legend()
plt.title("MSE")
plt.savefig("/Users/ericliao/Desktop/WNV_project_files/WNV/CDC_data/human/result/NN/nn_yearly_pca_mse.png", dpi=300)
plt.show()
...
plt.legend()
plt.title("MAE")
plt.savefig("/Users/ericliao/Desktop/WNV_project_files/WNV/CDC_data/human/result/NN/nn_yearly_pca_mae.png", dpi=300)
plt.show()
...
plt.legend()
plt.title("MAPE")
plt.savefig("/Users/ericliao/Desktop/WNV_project_files/WNV/CDC_data/human/result/NN/nn_yearly_pca_mape.png", dpi=300)
plt.show()
