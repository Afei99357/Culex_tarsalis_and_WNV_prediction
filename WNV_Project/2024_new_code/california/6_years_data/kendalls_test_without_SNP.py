...
## get index of column Total_Bird_WNV_Count
index = data.columns.get_loc("Total_Bird_WNV_Count")

## drop the columns after Total_Bird_WNV_Count
data = data.drop(data.columns[index + 1:], axis=1)
...
for column in kendall_corr.columns:
    if abs(kendall_corr.loc[column, "Human_WNND_Count"]) < 0.1:
...
plt.savefig("/Users/ericliao/Desktop/WNV_project_files/WNV/california/plots/heatmap_corr_kendall_without_snp.png", dpi=300)
...
data_new.to_csv("/Users/ericliao/Desktop/WNV_project_files/WNV/california/data/"
            "cali_week_wnnd_with_allele_frequency_without_snp_drop_low_target_corr.csv", index=False)
