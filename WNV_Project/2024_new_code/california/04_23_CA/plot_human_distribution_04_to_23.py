...
data["Human_Disease_Count"] = data["Human_Disease_Count"].round().astype(int)
...
for year in year_list:
    ...
    # save the plot
    plt.savefig('/Users/ericliao/Desktop/WNV_project_files/WNV/california/new_data_2004_2023/result/plots/California_yearly_case_distribution/human_wnv_' + str(year) + '.png')
