...
for i in range(len(years) - train_years):
    ...
    HGBR = ensemble.HistGradientBoostingRegressor(l2_regularization=0.8148480041604657, learning_rate=0.010781373992314703,
                                                 max_depth=3, max_iter=19, max_leaf_nodes=51, min_samples_leaf=8)
