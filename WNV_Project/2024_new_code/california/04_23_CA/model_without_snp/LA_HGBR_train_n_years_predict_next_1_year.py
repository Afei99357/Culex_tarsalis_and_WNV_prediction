...
for i in range(len(years) - train_years):
    ...
    df.to_csv("/Users/ericliao/Desktop/WNV_project_files/WNV/california/new_data_2004_2023/result/Histogram-Based Gradient Boosting Ensembles/EST_LA_03_to_24_result.csv")
