...
for year in years:
    if year < predict_year:
        ...
        plt.tight_layout()
        plt.savefig(f"/Users/ericliao/Desktop/WNV_project_files/WNV/california/CA_13_county_dataset/result/plots/shap_summary_accumulated_prediciton/global_shap_plot_{year}.png")
