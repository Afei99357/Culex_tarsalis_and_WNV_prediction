...
best_hyperparameter = pd.read_csv("/Users/ericliao/Desktop/WNV_project_files/WNV/california/CA_13_county_dataset/result"
                                  "/plots/RF/hyperparameter_tuning_plots/hyperparameter_tuning_rf_impute_0.csv",
                                  header=0, index_col=False)

## create a dataframe to store the Q^2 and RMSE, and tuning year and hyperparameters
df_output = pd.DataFrame(columns=["tuning_year","Q^2", "RMSE", "max_depth", "max_leaf_nodes", "min_samples_leaf", "n_estimators",
                                    "min_samples_split", "max_features", "max_samples", "min_impurity_decrease"])
...
for index, row in best_hyperparameter.iterrows():
    ...
    # Ensure max_features is correctly interpreted
    ...
    output_list.append([hyperparameter_tuning_year, q2, rmse, max_depth, max_leaf_nodes, min_samples_leaf, n_estimators,
                        min_samples_split, max_features, max_samples, min_impurity_decrease])
...
df_output = pd.DataFrame(output_list, columns=["tuning_year", "q2", "RMSE", "max_depth", "max_leaf_nodes", "min_samples_leaf",
                                              "n_estimators", "min_samples_split", "max_features", "max_samples",
                                              "min_impurity_decrease"])

## save the tuning year, q2 and RMSE to a csv file
df_output.to_csv("/Users/ericliao/Desktop/WNV_project_files/WNV/california/CA_13_county_dataset/result/plots/RF/hyperparameter_tuning_plots/"
                 "hyperparameter_tuning_rf_impute_0_q2_rmse.csv", index=False)