...
data_california = pd.read_csv("/Users/ericliao/Desktop/WNV_project_files/WNV/california/"
                              "CA_13_county_dataset/wnv_county_onsetmonth_2004-2023.csv", sep=",", index_col=0)
...
# ## for each row, if the "Human_WNND_Count" is nan, fill "Human_WNND_Count" with "0"
data.loc[data["Human_Disease_Count"].isna(), "Human_Disease_Count"] = 0
...
##output the data
data.to_csv("/Users/ericliao/Desktop/WNV_project_files/WNV/california/CA_13_county_dataset/CA_13_counties_04_23_impute_0.csv", index=False)
