...
column_list = ["COMMON NAME", "OBSERVATION COUNT", 'COUNTY', "STATE", "LATITUDE", "LONGITUDE", "OBSERVATION DATE", "APPROVED"]
...
column_dtype = {"COMMON NAME": str, "OBSERVATION COUNT": int, "STATE": str, "LATITUDE": float, "LONGITUDE": float,
...
disease_df = pd.read_csv("/Users/ericliao/Desktop/WNV_project_files/Data_for_Machine_Learning/ebirds_results/results/"
...
disease_df = disease_df.rename(columns={"OBSERVATION COUNT": "Gray Catbird"})

disease_df.to_csv("/Users/ericliao/Desktop/WNV_project_files/Data_for_Machine_Learning/ebirds_results/results/"
                  "add_0_for_no_wnv/cali_gray.csv", index=True)