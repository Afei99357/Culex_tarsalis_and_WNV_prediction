...
nonhuman_neural_df = pd.read_csv(
    "/Users/ericliao/Desktop/WNV_project_files/illinois_data/county_level_data_2018_2022/bird_illnois_2018_to_2022.csv",
    index_col=0
)

## create a column to combine the year, month as two digits, and date 1st of every month
nonhuman_neural_df["Date"] = nonhuman_neural_df["Year"].astype(str) + "-" + nonhuman_neural_df["Month"].astype(str).str.zfill(2) + "-01"

# create a data array based on the latitude from human_df
latitude_da = xr.DataArray(nonhuman_neural_df["County_Seat_Latitude"].values, dims="county")
# create a data array based on the longitude from human_df
longitude_da = xr.DataArray(nonhuman_neural_df["County_Seat_Longitude"].values, dims="county")
# create a data array based on the date from nonhuman_df
time_da = xr.DataArray(nonhuman_neural_df["Date"].values.astype("datetime64[D]"), dims="county")
...
nonhuman_neural_df["u10_1m_shift"] = alltime_all_var_values_shift_1["u10"].values
nonhuman_neural_df["v10_1m_shift"] = alltime_all_var_values_shift_1["v10"].values
nonhuman_neural_df["t2m_1m_shift"] = alltime_all_var_values_shift_1["t2m"].values
nonhuman_neural_df["lai_hv_1m_shift"] = alltime_all_var_values_shift_1["lai_hv"].values
nonhuman_neural_df["lai_lv_1m_shift"] = alltime_all_var_values_shift_1["lai_lv"].values
nonhuman_neural_df["src_1m_shift"] = alltime_all_var_values_shift_1["src"].values
nonhuman_neural_df["sf_1m_shift"] = alltime_all_var_values_shift_1["sf"].values
nonhuman_neural_df["sro_1m_shift"] = alltime_all_var_values_shift_1["sro"].values
nonhuman_neural_df["tp_1m_shift"] = alltime_all_var_values_shift_1["tp"].values
#
# alltime_all_var_values_shift_2 = alltime_all_var_values.shift(time=2).sel(time=time_da, method="nearest")
#
# nonhuman_neural_df["u10_2m_shift"] = alltime_all_var_values_shift_2["u10"].values
# nonhuman_neural_df["v10_2m_shift"] = alltime_all_var_values_shift_2["v10"].values
# nonhuman_neural_df["t2m_2m_shift"] = alltime_all_var_values_shift_2["t2m"].values
# nonhuman_neural_df["lai_hv_2m_shift"] = alltime_all_var_values_shift_2["lai_hv"].values
# nonhuman_neural_df["lai_lv_2m_shift"] = alltime_all_var_values_shift_2["lai_lv"].values
# nonhuman_neural_df["src_2m_shift"] = alltime_all_var_values_shift_2["src"].values
# nonhuman_neural_df["sf_2m_shift"] = alltime_all_var_values_shift_2["sf"].values
# nonhuman_neural_df["sro_2m_shift"] = alltime_all_var_values_shift_2["sro"].values
# nonhuman_neural_df["tp_2m_shift"] = alltime_all_var_values_shift_2["tp"].values
#
# alltime_all_var_values_shift_12 = alltime_all_var_values.shift(time=12).sel(time=time_da, method="nearest")
#
# nonhuman_neural_df["u10_12m_shift"] = alltime_all_var_values_shift_12["u10"].values
# nonhuman_neural_df["v10_12m_shift"] = alltime_all_var_values_shift_12["v10"].values
# nonhuman_neural_df["t2m_12m_shift"] = alltime_all_var_values_shift_12["t2m"].values
# nonhuman_neural_df["lai_hv_12m_shift"] = alltime_all_var_values_shift_12["lai_hv"].values
# nonhuman_neural_df["lai_lv_12m_shift"] = alltime_all_var_values_shift_12["lai_lv"].values
# nonhuman_neural_df["src_12m_shift"] = alltime_all_var_values_shift_12["src"].values
# nonhuman_neural_df["sf_12m_shift"] = alltime_all_var_values_shift_12["sf"].values
# nonhuman_neural_df["sro_12m_shift"] = alltime_all_var_values_shift_12["sro"].values
# nonhuman_neural_df["tp_12m_shift"] = alltime_all_var_values_shift_12["tp"].values
...
nonhuman_neural_df.to_csv(
    "/Users/ericliao/Desktop/WNV_project_files/illinois_data/county_level_data_2018_2022/"
    "bird_illinois_2018_2022_climate.csv",
    index=False,
)
