...
data = pd.read_csv("/Users/ericliao/Desktop/WNV_project_files/Data_for_Machine_Learning/ebirds_results/results/"
                   "add_0_for_no_wnv/cali_week_wnnd_multi_years_all_features_mosquitoes_bird_horse.csv", index_col=0)

# drop columns that are not features and drop target
data = data.drop(["State", "County", "Year", 'Month', 'Date', "County_Seat_Latitude", "County_Seat_Longitude", "FIPS",
                  "Human_WNND_Count",
                  "Human_WNND_Rate",
                  "WNV_Corvid_Count",
                  "WNV_NonCorvid_Count",
...
plt.text(25, -1, "Legend:", fontsize=25, rotation=0, c="black")
## add text as legend, for each row is a key and value in the dictionary
for i in range(len(labels)):
    plt.text(25, i, list(column_names_dict.items())[i], fontsize=25, rotation=0, c="black")
...
plt.savefig("/Users/ericliao/Desktop/WNV_project_files/Data_for_Machine_Learning/ebirds_results/plots"
            "/heatmap_corr_wnnd_multi_years_all_features_mosquito.png", dpi=300)
